...
public class CreateLobbyCommandMeta extends BotCommandMetaAdapter {
    ...
    public static final BotCommandArgumentMeta<String> MAX = BotCommandArgumentMeta.of("max", ArgumentTypes.STRING_ARGUMENT, ArgumentNecessity.OPTIONAL);
    ...
    public void accept(Map<String, BotCommandArgument<?>> arguments) {
        System.out.printf("Created Lobby %s.%n", getArg(arguments, LOBBY_NAME));
    }
}
